...
export const ShareIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.042.583.05a2.25 2.25 0 012.134 2.134c.008.193.025.388.05.583m-2.767-2.767a2.25 2.25 0 012.767 2.767m0 0a2.25 2.25 0 01-2.767 2.767m2.767-2.767a2.25 2.25 0 012.767 2.767m-2.767 2.767a2.25 2.25 0 01-2.767-2.767m2.767 2.767a2.25 2.25 0 01-2.767 2.767" />
    </svg>
);